...
from songmenu import Downloading_music,download_spleeter,localfile_spleeter
import sys
import os
...
class MainWindow(QMainWindow):
    ...
    def onvocal(self):
        ...
        try:
            ...
            download_spleeter(song_name,mode = 'onvocal')
            self.allo = True
    ...
    def localfile(self):
        ...
        '''
            ...
            download_spleeter(self.filename)
        '''
        self.allo = True
        self.close()
